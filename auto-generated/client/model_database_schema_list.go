...
// DatabaseSchemaList struct for DatabaseSchemaList
...
func (o DatabaseSchemaList) MarshalJSON() ([]byte, error) {
...
type NullableDatabaseSchemaList struct {
	value *DatabaseSchemaList
	isSet bool
}

func (v NullableDatabaseSchemaList) Get() *DatabaseSchemaList {
	return v.value
}

func (v *NullableDatabaseSchemaList) Set(val *DatabaseSchemaList) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseSchemaList) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseSchemaList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseSchemaList(val *DatabaseSchemaList) *NullableDatabaseSchemaList {
	return &NullableDatabaseSchemaList{value: val, isSet: true}
}

func (v NullableDatabaseSchemaList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseSchemaList) UnmarshalJSON(src []byte) error {
	v.isSet = true
