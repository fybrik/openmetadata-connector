...
// ResultListTagCategory struct for ResultListTagCategory
type ResultListTagCategory struct {
...
func (o ResultListTagCategory) MarshalJSON() ([]byte, error) {
...
type NullableResultListTagCategory struct {
	value *ResultListTagCategory
	isSet bool
}

func (v NullableResultListTagCategory) Get() *ResultListTagCategory {
	return v.value
}

func (v *NullableResultListTagCategory) Set(val *ResultListTagCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListTagCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListTagCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListTagCategory(val *ResultListTagCategory) *NullableResultListTagCategory {
	return &NullableResultListTagCategory{value: val, isSet: true}
}

func (v NullableResultListTagCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListTagCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
