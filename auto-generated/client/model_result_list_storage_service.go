...
// ResultListStorageService struct for ResultListStorageService
type ResultListStorageService struct {
...
func (o ResultListStorageService) MarshalJSON() ([]byte, error) {
...
type NullableResultListStorageService struct {
	value *ResultListStorageService
	isSet bool
}

func (v NullableResultListStorageService) Get() *ResultListStorageService {
	return v.value
}

func (v *NullableResultListStorageService) Set(val *ResultListStorageService) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListStorageService) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListStorageService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListStorageService(val *ResultListStorageService) *NullableResultListStorageService {
	return &NullableResultListStorageService{value: val, isSet: true}
}

func (v NullableResultListStorageService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListStorageService) UnmarshalJSON(src []byte) error {
	v.isSet = true
