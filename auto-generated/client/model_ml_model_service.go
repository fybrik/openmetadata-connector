...
// MlModelService struct for MlModelService
...
func (o MlModelService) MarshalJSON() ([]byte, error) {
...
type NullableMlModelService struct {
	value *MlModelService
	isSet bool
}

func (v NullableMlModelService) Get() *MlModelService {
	return v.value
}

func (v *NullableMlModelService) Set(val *MlModelService) {
	v.value = val
	v.isSet = true
}

func (v NullableMlModelService) IsSet() bool {
	return v.isSet
}

func (v *NullableMlModelService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMlModelService(val *MlModelService) *NullableMlModelService {
	return &NullableMlModelService{value: val, isSet: true}
}

func (v NullableMlModelService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMlModelService) UnmarshalJSON(src []byte) error {
	v.isSet = true
