...
// ResultListGlossary struct for ResultListGlossary
type ResultListGlossary struct {
...
func (o ResultListGlossary) MarshalJSON() ([]byte, error) {
...
type NullableResultListGlossary struct {
	value *ResultListGlossary
	isSet bool
}

func (v NullableResultListGlossary) Get() *ResultListGlossary {
	return v.value
}

func (v *NullableResultListGlossary) Set(val *ResultListGlossary) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListGlossary) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListGlossary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListGlossary(val *ResultListGlossary) *NullableResultListGlossary {
	return &NullableResultListGlossary{value: val, isSet: true}
}

func (v NullableResultListGlossary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListGlossary) UnmarshalJSON(src []byte) error {
	v.isSet = true
