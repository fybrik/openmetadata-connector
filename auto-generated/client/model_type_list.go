...
func (o TypeList) MarshalJSON() ([]byte, error) {
...
type NullableTypeList struct {
	value *TypeList
	isSet bool
}

func (v NullableTypeList) Get() *TypeList {
	return v.value
}

func (v *NullableTypeList) Set(val *TypeList) {
	v.value = val
	v.isSet = true
}

func (v NullableTypeList) IsSet() bool {
	return v.isSet
}

func (v *NullableTypeList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTypeList(val *TypeList) *NullableTypeList {
	return &NullableTypeList{value: val, isSet: true}
}

func (v NullableTypeList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTypeList) UnmarshalJSON(src []byte) error {
	v.isSet = true
