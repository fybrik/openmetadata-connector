...
// MlModelList struct for MlModelList
...
func (o MlModelList) MarshalJSON() ([]byte, error) {
...
type NullableMlModelList struct {
	value *MlModelList
	isSet bool
}

func (v NullableMlModelList) Get() *MlModelList {
	return v.value
}

func (v *NullableMlModelList) Set(val *MlModelList) {
	v.value = val
	v.isSet = true
}

func (v NullableMlModelList) IsSet() bool {
	return v.isSet
}

func (v *NullableMlModelList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMlModelList(val *MlModelList) *NullableMlModelList {
	return &NullableMlModelList{value: val, isSet: true}
}

func (v NullableMlModelList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMlModelList) UnmarshalJSON(src []byte) error {
	v.isSet = true
