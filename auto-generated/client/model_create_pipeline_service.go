...
// CreatePipelineService struct for CreatePipelineService
...
func (o CreatePipelineService) MarshalJSON() ([]byte, error) {
...
type NullableCreatePipelineService struct {
	value *CreatePipelineService
	isSet bool
}

func (v NullableCreatePipelineService) Get() *CreatePipelineService {
	return v.value
}

func (v *NullableCreatePipelineService) Set(val *CreatePipelineService) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePipelineService) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePipelineService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePipelineService(val *CreatePipelineService) *NullableCreatePipelineService {
	return &NullableCreatePipelineService{value: val, isSet: true}
}

func (v NullableCreatePipelineService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePipelineService) UnmarshalJSON(src []byte) error {
	v.isSet = true
