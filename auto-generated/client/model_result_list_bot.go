...
// ResultListBot struct for ResultListBot
type ResultListBot struct {
	Data   []Bot   `json:"data"`
...
func (o ResultListBot) MarshalJSON() ([]byte, error) {
...
type NullableResultListBot struct {
	value *ResultListBot
	isSet bool
}

func (v NullableResultListBot) Get() *ResultListBot {
	return v.value
}

func (v *NullableResultListBot) Set(val *ResultListBot) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListBot) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListBot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListBot(val *ResultListBot) *NullableResultListBot {
	return &NullableResultListBot{value: val, isSet: true}
}

func (v NullableResultListBot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListBot) UnmarshalJSON(src []byte) error {
	v.isSet = true
