...
// ResultListMetrics struct for ResultListMetrics
type ResultListMetrics struct {
...
func (o ResultListMetrics) MarshalJSON() ([]byte, error) {
...
type NullableResultListMetrics struct {
	value *ResultListMetrics
	isSet bool
}

func (v NullableResultListMetrics) Get() *ResultListMetrics {
	return v.value
}

func (v *NullableResultListMetrics) Set(val *ResultListMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListMetrics(val *ResultListMetrics) *NullableResultListMetrics {
	return &NullableResultListMetrics{value: val, isSet: true}
}

func (v NullableResultListMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
