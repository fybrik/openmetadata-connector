...
// ResultListChangeEvent struct for ResultListChangeEvent
type ResultListChangeEvent struct {
...
func (o ResultListChangeEvent) MarshalJSON() ([]byte, error) {
...
type NullableResultListChangeEvent struct {
	value *ResultListChangeEvent
	isSet bool
}

func (v NullableResultListChangeEvent) Get() *ResultListChangeEvent {
	return v.value
}

func (v *NullableResultListChangeEvent) Set(val *ResultListChangeEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListChangeEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListChangeEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListChangeEvent(val *ResultListChangeEvent) *NullableResultListChangeEvent {
	return &NullableResultListChangeEvent{value: val, isSet: true}
}

func (v NullableResultListChangeEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListChangeEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
