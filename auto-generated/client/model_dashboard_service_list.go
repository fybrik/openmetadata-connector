...
// DashboardServiceList struct for DashboardServiceList
...
func (o DashboardServiceList) MarshalJSON() ([]byte, error) {
...
type NullableDashboardServiceList struct {
	value *DashboardServiceList
	isSet bool
}

func (v NullableDashboardServiceList) Get() *DashboardServiceList {
	return v.value
}

func (v *NullableDashboardServiceList) Set(val *DashboardServiceList) {
	v.value = val
	v.isSet = true
}

func (v NullableDashboardServiceList) IsSet() bool {
	return v.isSet
}

func (v *NullableDashboardServiceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDashboardServiceList(val *DashboardServiceList) *NullableDashboardServiceList {
	return &NullableDashboardServiceList{value: val, isSet: true}
}

func (v NullableDashboardServiceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDashboardServiceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
