...
// ResultListRole struct for ResultListRole
type ResultListRole struct {
	Data   []Role  `json:"data"`
...
func (o ResultListRole) MarshalJSON() ([]byte, error) {
...
type NullableResultListRole struct {
	value *ResultListRole
	isSet bool
}

func (v NullableResultListRole) Get() *ResultListRole {
	return v.value
}

func (v *NullableResultListRole) Set(val *ResultListRole) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListRole) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListRole) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListRole(val *ResultListRole) *NullableResultListRole {
	return &NullableResultListRole{value: val, isSet: true}
}

func (v NullableResultListRole) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListRole) UnmarshalJSON(src []byte) error {
	v.isSet = true
