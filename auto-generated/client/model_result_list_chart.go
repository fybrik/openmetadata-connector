...
// ResultListChart struct for ResultListChart
type ResultListChart struct {
...
func (o ResultListChart) MarshalJSON() ([]byte, error) {
...
type NullableResultListChart struct {
	value *ResultListChart
	isSet bool
}

func (v NullableResultListChart) Get() *ResultListChart {
	return v.value
}

func (v *NullableResultListChart) Set(val *ResultListChart) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListChart) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListChart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListChart(val *ResultListChart) *NullableResultListChart {
	return &NullableResultListChart{value: val, isSet: true}
}

func (v NullableResultListChart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListChart) UnmarshalJSON(src []byte) error {
	v.isSet = true
