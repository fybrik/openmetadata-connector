...
// ReportList struct for ReportList
...
func (o ReportList) MarshalJSON() ([]byte, error) {
...
type NullableReportList struct {
	value *ReportList
	isSet bool
}

func (v NullableReportList) Get() *ReportList {
	return v.value
}

func (v *NullableReportList) Set(val *ReportList) {
	v.value = val
	v.isSet = true
}

func (v NullableReportList) IsSet() bool {
	return v.isSet
}

func (v *NullableReportList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportList(val *ReportList) *NullableReportList {
	return &NullableReportList{value: val, isSet: true}
}

func (v NullableReportList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportList) UnmarshalJSON(src []byte) error {
	v.isSet = true
