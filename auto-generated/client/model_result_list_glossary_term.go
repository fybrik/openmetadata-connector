...
// ResultListGlossaryTerm struct for ResultListGlossaryTerm
type ResultListGlossaryTerm struct {
...
func (o ResultListGlossaryTerm) MarshalJSON() ([]byte, error) {
...
type NullableResultListGlossaryTerm struct {
	value *ResultListGlossaryTerm
	isSet bool
}

func (v NullableResultListGlossaryTerm) Get() *ResultListGlossaryTerm {
	return v.value
}

func (v *NullableResultListGlossaryTerm) Set(val *ResultListGlossaryTerm) {
	v.value = val
	v.isSet = true
}

func (v NullableResultListGlossaryTerm) IsSet() bool {
	return v.isSet
}

func (v *NullableResultListGlossaryTerm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultListGlossaryTerm(val *ResultListGlossaryTerm) *NullableResultListGlossaryTerm {
	return &NullableResultListGlossaryTerm{value: val, isSet: true}
}

func (v NullableResultListGlossaryTerm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultListGlossaryTerm) UnmarshalJSON(src []byte) error {
	v.isSet = true
