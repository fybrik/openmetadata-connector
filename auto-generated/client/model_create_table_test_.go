...
// CreateTableTest struct for CreateTableTest
...
func (o CreateTableTest) MarshalJSON() ([]byte, error) {
...
type NullableCreateTableTest struct {
	value *CreateTableTest
	isSet bool
}

func (v NullableCreateTableTest) Get() *CreateTableTest {
	return v.value
}

func (v *NullableCreateTableTest) Set(val *CreateTableTest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateTableTest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateTableTest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateTableTest(val *CreateTableTest) *NullableCreateTableTest {
	return &NullableCreateTableTest{value: val, isSet: true}
}

func (v NullableCreateTableTest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateTableTest) UnmarshalJSON(src []byte) error {
	v.isSet = true
