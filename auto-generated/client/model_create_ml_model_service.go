...
// CreateMlModelService struct for CreateMlModelService
type CreateMlModelService struct {
	Connection  MlModelConnection      `json:"connection"`
...
func (o CreateMlModelService) MarshalJSON() ([]byte, error) {
...
type NullableCreateMlModelService struct {
	value *CreateMlModelService
	isSet bool
}

func (v NullableCreateMlModelService) Get() *CreateMlModelService {
	return v.value
}

func (v *NullableCreateMlModelService) Set(val *CreateMlModelService) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMlModelService) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMlModelService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMlModelService(val *CreateMlModelService) *NullableCreateMlModelService {
	return &NullableCreateMlModelService{value: val, isSet: true}
}

func (v NullableCreateMlModelService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMlModelService) UnmarshalJSON(src []byte) error {
	v.isSet = true
