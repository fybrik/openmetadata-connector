...
// DatabaseServiceList struct for DatabaseServiceList
...
func (o DatabaseServiceList) MarshalJSON() ([]byte, error) {
...
type NullableDatabaseServiceList struct {
	value *DatabaseServiceList
	isSet bool
}

func (v NullableDatabaseServiceList) Get() *DatabaseServiceList {
	return v.value
}

func (v *NullableDatabaseServiceList) Set(val *DatabaseServiceList) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseServiceList) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseServiceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseServiceList(val *DatabaseServiceList) *NullableDatabaseServiceList {
	return &NullableDatabaseServiceList{value: val, isSet: true}
}

func (v NullableDatabaseServiceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseServiceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
