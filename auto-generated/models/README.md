...
```golang
import openapi "fybrik.io/openmetadata-connector/datacatalog-go-models"
```
...
## Documentation For Models
 ...
 - [DeleteAssetRequest](docs/DeleteAssetRequest.md)
 ...
 - [ResourceColumn](docs/ResourceColumn.md)
